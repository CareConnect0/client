...
class SplashSign extends StatelessWidget {
  const SplashSign({super.key});
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 15),
              Semibold_28px(text: "함께하루", color: CareConnectColor.primary[900]),
              SizedBox(height: 75),
              InkWell(
                onTap: () {
                  context.push('/signIn');
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: Center(child: Bold_22px(text: "회원가입")),
                ),
              ),
            ],
          ),
