...
class EnrollAiChat extends ConsumerStatefulWidget {
  const EnrollAiChat({super.key});

  @override
  ConsumerState<EnrollAiChat> createState() => _EnrollScheduleState();
}

class _EnrollScheduleState extends ConsumerState<EnrollAiChat> {
  @override
