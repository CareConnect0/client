...
class EnrollMessage extends ConsumerStatefulWidget {
  const EnrollMessage({super.key});

  @override
  ConsumerState<EnrollMessage> createState() => _EnrollScheduleState();
}

class _EnrollScheduleState extends ConsumerState<EnrollMessage> {
  @override
